...
species.dat = species.dat[,.(SpeciesID,Species.Cat,Inclusion.Cat,Indicator,Native.Status,Duration, Type, Legume, Photopath, Range, Distribution)] #add in more as I complete plant trait data
