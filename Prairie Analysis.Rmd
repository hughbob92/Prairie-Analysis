...
write.table(table(unique(cover[!(Action==""),.(Action,Year,TransectID)])[,.(Action,Year)]),pipe("pbcopy")) #observed years
...
write.table(table(tab.action.all[,.(Mgmt.2010,Year)]),pipe("pbcopy")) #All years
...
cover.map.2 = unique(cover[,.(TransectID,MGMTUNIT_I,SITE_ID,StartLat,StartLong,Protocol,ManUnitAcres,Action,Year,ir_tran,change_ir_tran,
                              nr_tran,change_nr_tran,indf.n2.tran,indf.n1.tran,indf.i2.tran,indf.i1.tran,indf.i.tran,indf.n.tran,if.tran,nf.tran)])
